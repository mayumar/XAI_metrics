# xai_metrics/metrics/fidelity/completeness/average_increase.py
...
@register_metric
class AverageIncreaseMetric(BaseMetric):
    NAME = "AverageIncreaseMetric"
    ...
    def run(self):
        ...
        metric = fidelity.AverageIncreaseMetric(
            model=ctx.model,
            inputs=X,
            targets=targets,
